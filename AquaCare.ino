...
#define BOTtoken "6342306281:AAGwj7SES_Bd4OcHA3MBQdAQxRCxCxzYsOM"
...
float readTurbidity() {
  // Read the turbidity value from the sensor and return the result
  int rawValue = analogRead(Turbudity_PIN);
  // Convert raw value to turbidity level (you may need to calibrate this according to your sensor)
...
void handleNewMessages(int numNewMessages) {
  for (int i = 0; i < numNewMessages; i++) {
    ...
    if (text == "/start") {
      ...
      phValue = 3.5 * phValue;
      String turbidityMessage = "Turbidity of Water is : " + String(turbidityValue) + " PPM\n";
